/*
Có 3 items để đấu giá
Có 4 người sẽ được đấu giá
Người đầu tiên deploy gửi sẽ là beneficiary
function bid() sẽ xóa bớt tokens remaining và sẽ push vào itemTokens với personId 
 */
...
contract Auction {
   ...
   //Structure to hold the details of a persons
    ...
    // first time when depploy smart contract
    ...
    // register with msg.sender
        // mỗi lần register() sẽ add vào array bidders (remainingTokens: 5, personId: bidderCount, addr: msg.sender)
    ...
    function bid(uint _itemId, uint _count) public payable{
        ...
        */
        ...
        Part 1 Task 4. Implement the three conditions below.
            4.1 If the number of tokens remaining with the bidder is < count of tokens bidded, revert. => if(_count > remainingTokens) ~> Wrong
            4.2 If there are no tokens remaining with the bidder, revert. => Dont have remainingTokens to bid
            4.3 If the id of the item for which bid is placed, is greater than 2, revert. => Having 3 items(0,1,2) in array items
    ...
    function revealWinners() public onlyOwner{
        ...
        // array items have 3 elements => id < 3
